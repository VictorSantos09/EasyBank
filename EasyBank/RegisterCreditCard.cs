namespace EasyBank
{
    ...
    {
        public void CreditCardRegister(List<User> listUser, int userMonthlyIncome, List<CreditCard> creditCards)
        {
            // SafetyKey - Thiago
            // Numero cartão
            creditCards.Add(new CreditCard(R_Limit(userMonthlyIncome), R_NameOwner(listUser),
                R_CVV(), null, R_ExpireDate()));
        }
