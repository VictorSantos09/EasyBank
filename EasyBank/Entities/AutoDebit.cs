    ...
    public class AutoDebit : Bill
    {
        ...
        public void Menu(List<AutoDebit> autoDebits, int userID)
        {
            ...
            while (true)
            {
                ...
                switch (optionMenu)
                {
                    ...
                    default:
                        MessageError.ErrorThread("Digite uma opção válida: '1', '2', '3', '4' ou '5'");
                        break;
                }
            }
        }
        ...
        public void RemoveAutoDebit(List<AutoDebit> autoDebits, int userID)
        {
            ...
            if (userAutoDebits.Count == 0)
                MessageError.ErrorThread("Nenhuma conta cadastrada");
        ...
        public float FillInInformation(string option)
        {
            ...
            Console.WriteLine($"A conta de {option}, no valor de {amountDebited} será paga automaticamente no mesmo dia que " +
