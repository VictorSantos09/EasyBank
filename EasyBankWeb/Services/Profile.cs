...
namespace EasyBankWeb.Services
{
    public class Profile
    {
        ...
        public Profile(ProfileRepository profileRepository, UserRepository userRepository, CreditCardRepository creditCardRepository, Register register)
        {
        ...
        public bool ViewProfile(int userID, bool logged)
        {
            ...
            var register = _register.GetUsers().Find(x => x.Id == userID);
